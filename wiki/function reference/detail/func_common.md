...
&emsp;&emsp;Returns y\[i\] if x\[i\] &lt; y\[i\]; otherwise, it returns x\[i\]\. If one of the two arguments is NaN,  
&emsp;&emsp;the value of the other argument is returned\.  
...
&emsp;&emsp;For every index i:  
&emsp;&emsp;Returns y\[i\] if y\[i\] &lt; x\[i\]; otherwise, it returns x\[i\]\. If one of the two arguments is NaN,  
&emsp;&emsp;the value of the other argument is returned\.  
...
### mod\(\) function  
#### <code>glm.<code>**mod**(**x**: *vecN*, **y**: *vecN*) -\> *vecN*</code></code>  
&emsp;&emsp;Returns x \- y \* floor\(x / y\) for each component in x using the floating point value y\.  
  
#### <code>glm.<code>**mod**(**x**: *vecN*, **y**: *number*) -\> *vecN*</code></code>  
&emsp;&emsp;Returns x \- y \* floor\(x / y\) for each component in x using the floating point value y\.  
  
#### <code>glm.<code>**mod**(**x**: *number*, **y**: *number*) -\> *number*</code></code>  
&emsp;&emsp;Returns x \- y \* floor\(x / y\) for each component in x using the floating point value y\.  
