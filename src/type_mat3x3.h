...
{
	char * out = (char*)malloc((175) * sizeof(char));
	snprintf(out, 175, "tmat3x3( ( %10.10g, %10.10g, %10.10g ), ( %10.10g, %10.10g, %10.10g ), ( %10.10g, %10.10g, %10.10g ) )", self->x->x, self->x->y, self->x->z, self->y->x, self->y->y, self->y->z, self->z->x, self->z->y, self->z->z);
...
{
	char * out = (char*)malloc((176) * sizeof(char));
	snprintf(out, 176, "tmat3x3\n[ %10.10g | %10.10g | %10.10g ]\n[ %10.10g | %10.10g | %10.10g ]\n[ %10.10g | %10.10g | %10.10g ]", self->x->x, self->x->y, self->x->z, self->y->x, self->y->y, self->y->z, self->z->x, self->z->y, self->z->z);
	return PyUnicode_FromString(out);
}
...
static int tmat3x3_contains(tmat3x3 * self, PyObject * value) {
	...
	return (int)((self->x->x == o->x && self->x->y == o->y && self->x->z == o->z) || (self->y->x == o->x && self->y->y == o->y && self->y->z == o->z) || (self->z->x == o->x && self->z->y == o->y && self->z->z == o->z));
}
...
static int tmat3x3_setattr(PyObject * obj, PyObject * name, PyObject * value) {
	...
	if (strcmp(name_as_ccp, "x") == 0) {
		...
		*((tmat3x3*)obj)->x = *((tvec3*)build_ivec3p(o));
		return 0;
	}
	if (strcmp(name_as_ccp, "y") == 0) {
		...
		*((tmat3x3*)obj)->y = *((tvec3*)build_ivec3p(o));
		return 0;
	}
	if (strcmp(name_as_ccp, "z") == 0) {
		...
		*((tmat3x3*)obj)->z = *((tvec3*)build_ivec3p(o));
		return 0;
	}
	return PyObject_GenericSetAttr(obj, name, value);
}
