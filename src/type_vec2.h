...
{
	char * out = (char*)malloc((45) * sizeof(char));
	snprintf(out, 45,"tvec2( %10.10g, %10.10g )", self->x, self->y);
...
static double * unswizzle_tvec2(tvec2 * self, char c) {
	if (c == 'x' || c == 'r' || c == 's') {
		return &self->x;
	}
	if (c == 'y' || c == 'g' || c == 't') {
...
static PyObject * tvec2_getattr(PyObject * obj, PyObject * name) {
	...
	if (len == 1) {
		double *x = unswizzle_tvec2((tvec2 *)obj, name_as_ccp[0]);
		if (x != NULL) {
		...
		double *x = unswizzle_tvec2((tvec2 *)obj, name_as_ccp[0]);
		double *y = unswizzle_tvec2((tvec2 *)obj, name_as_ccp[1]);
		if (x != NULL && y != NULL) {
		...
		double *x = unswizzle_tvec2((tvec2 *)obj, name_as_ccp[0]);
		double *y = unswizzle_tvec2((tvec2 *)obj, name_as_ccp[1]);
		double *z = unswizzle_tvec2((tvec2 *)obj, name_as_ccp[2]);
		...
		double *y = unswizzle_tvec2((tvec2 *)obj, name_as_ccp[1]);
		double *z = unswizzle_tvec2((tvec2 *)obj, name_as_ccp[2]);
		double *w = unswizzle_tvec2((tvec2 *)obj, name_as_ccp[3]);
