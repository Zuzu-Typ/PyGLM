...
tmat4x4_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
	...
	PyObject *v1 = pack_tvec4(1, 0, 0, 0);
	PyObject *v2 = pack_tvec4(0, 1, 0, 0);
	PyObject *v3 = pack_tvec4(0, 0, 1, 0);
	PyObject *v4 = pack_tvec4(0, 0, 0, 1);
...
{
	char * out = (char*)malloc((298) * sizeof(char));
	snprintf(out, 298, "tmat4x4( ( %10.10g, %10.10g, %10.10g, %10.10g ), ( %10.10g, %10.10g, %10.10g, %10.10g ), ( %10.10g, %10.10g, %10.10g, %10.10g ), ( %10.10g, %10.10g, %10.10g, %10.10g ) )", self->x->x, self->x->y, self->x->z, self->x->w, self->y->x, self->y->y, self->y->z, self->y->w, self->z->x, self->z->y, self->z->z, self->z->w, self->w->x, self->w->y, self->w->z, self->w->w);
...
{
	char * out = (char*)malloc((304) * sizeof(char));
	snprintf(out, 304, "tmat4x4\n[ %10.10g | %10.10g | %10.10g | %10.10g ]\n[ %10.10g | %10.10g | %10.10g | %10.10g ]\n[ %10.10g | %10.10g | %10.10g | %10.10g ]\n[ %10.10g | %10.10g | %10.10g | %10.10g ]", self->x->x, self->x->y, self->x->z, self->x->w, self->y->x, self->y->y, self->y->z, self->y->w, self->z->x, self->z->y, self->z->z, self->z->w, self->w->x, self->w->y, self->w->z, self->w->w);
	return PyUnicode_FromString(out);
}
...
static int tmat4x4_sq_setitem(tmat4x4 * self, Py_ssize_t index, PyObject * value) {
	...
	switch (index) {
	case 0:
		*self->x = *(tvec4*)build_ivec4p(o);
		return 0;
	case 1:
		*self->y = *(tvec4*)build_ivec4p(o);
		return 0;
	case 2:
		*self->z = *(tvec4*)build_ivec4p(o);
		return 0;
	case 3:
		*self->w = *(tvec4*)build_ivec4p(o);
		return 0;
	case -1:
		*self->w = *(tvec4*)build_ivec4p(o);
		return 0;
...
static int tmat4x4_contains(tmat4x4 * self, PyObject * value) {
	...
	return (int)((self->x->x == o->x && self->x->y == o->y && self->x->z == o->z && self->x->w == o->w) || (self->y->x == o->x && self->y->y == o->y && self->y->z == o->z && self->y->w == o->w) || (self->z->x == o->x && self->z->y == o->y && self->z->z == o->z && self->z->w == o->w) || (self->w->x == o->x && self->w->y == o->y && self->w->z == o->z && self->w->w == o->w));
}
...
static int tmat4x4_setattr(PyObject * obj, PyObject * name, PyObject * value) {
	...
	if (strcmp(name_as_ccp, "x") == 0) {
		...
		*((tmat4x4*)obj)->x = *((tvec4*)build_ivec4p(o));
		return 0;
	}
	if (strcmp(name_as_ccp, "y") == 0) {
		...
		*((tmat4x4*)obj)->y = *((tvec4*)build_ivec4p(o));
		return 0;
	}
	if (strcmp(name_as_ccp, "z") == 0) {
		...
		*((tmat4x4*)obj)->z = *((tvec4*)build_ivec4p(o));
		return 0;
	}
	if (strcmp(name_as_ccp, "w") == 0) {
		...
		*((tmat4x4*)obj)->w = *((tvec4*)build_ivec4p(o));
		return 0;
	}
	return PyObject_GenericSetAttr(obj, name, value);
}
