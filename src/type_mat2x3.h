...
{
	char * out = (char*)malloc((120) * sizeof(char));
	snprintf(out, 120, "tmat2x3( ( %10.10g, %10.10g, %10.10g ), ( %10.10g, %10.10g, %10.10g ) )", self->x->x, self->x->y, self->x->z, self->y->x, self->y->y, self->y->z);
...
{
	char * out = (char*)malloc((120) * sizeof(char));
	snprintf(out, 120, "tmat2x3\n[ %10.10g | %10.10g | %10.10g ]\n[ %10.10g | %10.10g | %10.10g ]", self->x->x, self->x->y, self->x->z, self->y->x, self->y->y, self->y->z);
	return PyUnicode_FromString(out);
}
...
static int tmat2x3_contains(tmat2x3 * self, PyObject * value) {
	...
	return (int)((self->x->x == o->x && self->x->y == o->y && self->x->z == o->z) || (self->y->x == o->x && self->y->y == o->y && self->y->z == o->z));
}
...
static int tmat2x3_setattr(PyObject * obj, PyObject * name, PyObject * value) {
	...
	if (strcmp(name_as_ccp, "x") == 0) {
		...
		*((tmat2x3*)obj)->x = *((tvec3*)build_ivec3p(o));
		return 0;
	}
	if (strcmp(name_as_ccp, "y") == 0) {
		...
		*((tmat2x3*)obj)->y = *((tvec3*)build_ivec3p(o));
		return 0;
	}
	return PyObject_GenericSetAttr(obj, name, value);
}
