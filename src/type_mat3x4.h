...
{
	char * out = (char*)malloc((226) * sizeof(char));
	snprintf(out, 226, "tmat3x4( ( %10.10g, %10.10g, %10.10g, %10.10g ), ( %10.10g, %10.10g, %10.10g, %10.10g ), ( %10.10g, %10.10g, %10.10g, %10.10g ) )", self->x->x, self->x->y, self->x->z, self->x->w, self->y->x, self->y->y, self->y->z, self->y->w, self->z->x, self->z->y, self->z->z, self->z->w);
...
tmat3x4_repr(tmat3x4* self)
{
	...
	snprintf(out, 230, "tmat3x4\n[ %10.10g | %10.10g | %10.10g | %10.10g ]\n[ %10.10g | %10.10g | %10.10g | %10.10g ]\n[ %10.10g | %10.10g | %10.10g | %10.10g ]", self->x->x, self->x->y, self->x->z, self->x->w, self->y->x, self->y->y, self->y->z, self->y->w, self->z->x, self->z->y, self->z->z, self->z->w);
	return PyUnicode_FromString(out);
}
...
static int tmat3x4_contains(tmat3x4 * self, PyObject * value) {
	...
	return (int)((self->x->x == o->x && self->x->y == o->y && self->x->z == o->z && self->x->w == o->w) || (self->y->x == o->x && self->y->y == o->y && self->y->z == o->z && self->y->w == o->w) || (self->z->x == o->x && self->z->y == o->y && self->z->z == o->z && self->z->w == o->w));
}
...
static int tmat3x4_setattr(PyObject * obj, PyObject * name, PyObject * value) {
	...
	if (strcmp(name_as_ccp, "x") == 0) {
		...
		*((tmat3x4*)obj)->x = *((tvec4*)build_ivec4p(o));
		return 0;
	}
	if (strcmp(name_as_ccp, "y") == 0) {
		...
		*((tmat3x4*)obj)->y = *((tvec4*)build_ivec4p(o));
		return 0;
	}
	if (strcmp(name_as_ccp, "z") == 0) {
		...
		*((tmat3x4*)obj)->z = *((tvec4*)build_ivec4p(o));
		return 0;
	}
	return PyObject_GenericSetAttr(obj, name, value);
}
