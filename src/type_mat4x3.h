...
tmat4x3_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
	...
	PyObject *v1 = pack_tvec3(1, 0, 0);
	PyObject *v2 = pack_tvec3(0, 1, 0);
	PyObject *v3 = pack_tvec3(0, 0, 1);
...
{
	char * out = (char*)malloc((230) * sizeof(char));
	snprintf(out, 230, "tmat4x3( ( %10.10g, %10.10g, %10.10g ), ( %10.10g, %10.10g, %10.10g ), ( %10.10g, %10.10g, %10.10g ), ( %10.10g, %10.10g, %10.10g ) )", self->x->x, self->x->y, self->x->z, self->y->x, self->y->y, self->y->z, self->z->x, self->z->y, self->z->z, self->w->x, self->w->y, self->w->z);
...
{
	char * out = (char*)malloc((232) * sizeof(char));
	snprintf(out, 232, "tmat4x3\n[ %10.10g | %10.10g | %10.10g ]\n[ %10.10g | %10.10g | %10.10g ]\n[ %10.10g | %10.10g | %10.10g ]\n[ %10.10g | %10.10g | %10.10g ]", self->x->x, self->x->y, self->x->z, self->y->x, self->y->y, self->y->z, self->z->x, self->z->y, self->z->z, self->w->x, self->w->y, self->w->z);
	return PyUnicode_FromString(out);
}
...
static int tmat4x3_sq_setitem(tmat4x3 * self, Py_ssize_t index, PyObject * value) {
	...
	switch (index) {
	case 0:
		*self->x = *(tvec3*)build_ivec3p(o);
		return 0;
	case 1:
		*self->y = *(tvec3*)build_ivec3p(o);
		return 0;
	case 2:
		*self->z = *(tvec3*)build_ivec3p(o);
		return 0;
	case 3:
		*self->w = *(tvec3*)build_ivec3p(o);
		return 0;
	case -1:
		*self->w = *(tvec3*)build_ivec3p(o);
		return 0;
...
static int tmat4x3_contains(tmat4x3 * self, PyObject * value) {
	...
	return (int)((self->x->x == o->x && self->x->y == o->y && self->x->z == o->z) || (self->y->x == o->x && self->y->y == o->y && self->y->z == o->z) || (self->z->x == o->x && self->z->y == o->y && self->z->z == o->z) || (self->w->x == o->x && self->w->y == o->y && self->w->z == o->z));
}
...
static int tmat4x3_setattr(PyObject * obj, PyObject * name, PyObject * value) {
	...
	if (strcmp(name_as_ccp, "x") == 0) {
		...
		*((tmat4x3*)obj)->x = *((tvec3*)build_ivec3p(o));
		return 0;
	}
	if (strcmp(name_as_ccp, "y") == 0) {
		...
		*((tmat4x3*)obj)->y = *((tvec3*)build_ivec3p(o));
		return 0;
	}
	if (strcmp(name_as_ccp, "z") == 0) {
		...
		*((tmat4x3*)obj)->z = *((tvec3*)build_ivec3p(o));
		return 0;
	}
	if (strcmp(name_as_ccp, "w") == 0) {
		...
		*((tmat4x3*)obj)->w = *((tvec3*)build_ivec3p(o));
		return 0;
	}
	return PyObject_GenericSetAttr(obj, name, value);
}
