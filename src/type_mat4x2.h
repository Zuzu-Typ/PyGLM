...
{
	char * out = (char*)malloc((162) * sizeof(char));
	snprintf(out, 162, "tmat4x2( ( %10.10g, %10.10g ), ( %10.10g, %10.10g ), ( %10.10g, %10.10g ), ( %10.10g, %10.10g ) )", self->x->x, self->x->y, self->y->x, self->y->y, self->z->x, self->z->y, self->w->x, self->w->y);
...
{
	char * out = (char*)malloc((160) * sizeof(char));
	snprintf(out, 160, "tmat4x2\n[ %10.10g | %10.10g ]\n[ %10.10g | %10.10g ]\n[ %10.10g | %10.10g ]\n[ %10.10g | %10.10g ]", self->x->x, self->x->y, self->y->x, self->y->y, self->z->x, self->z->y, self->w->x, self->w->y);
	return PyUnicode_FromString(out);
}
...
static int tmat4x2_contains(tmat4x2 * self, PyObject * value) {
	...
	return (int)((self->x->x == o->x && self->x->y == o->y) || (self->y->x == o->x && self->y->y == o->y) || (self->z->x == o->x && self->z->y == o->y) || (self->w->x == o->x && self->w->y == o->y));
}
...
static int tmat4x2_setattr(PyObject * obj, PyObject * name, PyObject * value) {
	...
	if (strcmp(name_as_ccp, "x") == 0) {
		...
		*((tmat4x2*)obj)->x = *((tvec2*)build_ivec2p(o));
		return 0;
	}
	if (strcmp(name_as_ccp, "y") == 0) {
		...
		*((tmat4x2*)obj)->y = *((tvec2*)build_ivec2p(o));
		return 0;
	}
	if (strcmp(name_as_ccp, "z") == 0) {
		...
		*((tmat4x2*)obj)->z = *((tvec2*)build_ivec2p(o));
		return 0;
	}
	if (strcmp(name_as_ccp, "w") == 0) {
		...
		*((tmat4x2*)obj)->w = *((tvec2*)build_ivec2p(o));
		return 0;
	}
	return PyObject_GenericSetAttr(obj, name, value);
}
