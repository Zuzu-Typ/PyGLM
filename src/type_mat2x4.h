...
{
	char * out = (char*)malloc((154) * sizeof(char));
	snprintf(out, 154, "tmat2x4( ( %10.10g, %10.10g, %10.10g, %10.10g ), ( %10.10g, %10.10g, %10.10g, %10.10g ) )", self->x->x, self->x->y, self->x->z, self->x->w, self->y->x, self->y->y, self->y->z, self->y->w);
...
{
	char * out = (char*)malloc((156) * sizeof(char));
	snprintf(out, 156, "tmat2x4\n[ %10.10g | %10.10g | %10.10g | %10.10g ]\n[ %10.10g | %10.10g | %10.10g | %10.10g ]", self->x->x, self->x->y, self->x->z, self->x->w, self->y->x, self->y->y, self->y->z, self->y->w);
	return PyUnicode_FromString(out);
}
...
static int tmat2x4_contains(tmat2x4 * self, PyObject * value) {
	...
	return (int)((self->x->x == o->x && self->x->y == o->y && self->x->z == o->z && self->x->w == o->w) || (self->y->x == o->x && self->y->y == o->y && self->y->z == o->z && self->y->w == o->w));
}
...
static int tmat2x4_setattr(PyObject * obj, PyObject * name, PyObject * value) {
	...
	if (strcmp(name_as_ccp, "x") == 0) {
		...
		*((tmat2x4*)obj)->x = *((tvec4*)build_ivec4p(o));
		return 0;
	}
	if (strcmp(name_as_ccp, "y") == 0) {
		...
		*((tmat2x4*)obj)->y = *((tvec4*)build_ivec4p(o));
		return 0;
	}
	return PyObject_GenericSetAttr(obj, name, value);
}
