...
static PyNumberMethods hu8vec1NumMethods = {
	...
	(binaryfunc)vec_div<1, glm::u8>, //nb_floor_divide
	(binaryfunc)vec_div<1, glm::u8>,
	(binaryfunc)vec_idiv<1, glm::u8>, //nb_inplace_floor_divide
...
static PyGLMTypeObject hu8vec1GLMType = {
	{
		PyVarObject_HEAD_INIT(NULL, 0)
		"glm.u8vec1",             /* tp_name */
		...
		(setattrofunc)vec_setattr<1, glm::u8>,                         /* tp_setattro */
	...
	0,
	sizeof(uint8),
	sizeof(glm::vec<1, uint8>),
	PyGLM_FS_UINT8
};

static PyTypeObject& hu8vec1Type = *((PyTypeObject*)&hu8vec1GLMType);