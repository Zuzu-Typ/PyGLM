...
static PyNumberMethods hi8vec4NumMethods = {
	...
	(binaryfunc)ivec_floordiv<4, glm::i8>, //nb_floor_divide
	(binaryfunc)vec_div<4, glm::i8>,
	(binaryfunc)ivec_ifloordiv<4, glm::i8>, //nb_inplace_floor_divide
...
static PyGLMTypeObject hi8vec4GLMType = {
	{
		PyVarObject_HEAD_INIT(NULL, 0)
		"glm.i8vec4",             /* tp_name */
	...
	0,
	sizeof(int8),
	sizeof(glm::vec<4, int8>),
	PyGLM_FS_INT8
};

static PyTypeObject& hi8vec4Type = *((PyTypeObject*)&hi8vec4GLMType);