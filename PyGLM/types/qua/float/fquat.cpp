...
#include "../../../types/quaIter.hpp"

PyMethodDef hfqua_methods[] = {
...
PyNumberMethods hfquaNumMethods = {
...
PyGLMTypeObject hfquaGLMType = _PyGLM_TYPE_DEF_FQUA;

PyTypeObject& hfquaType = *((PyTypeObject*)&hfquaGLMType);
