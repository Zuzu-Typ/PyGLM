...
PyBufferProcs hu64vec3BufferMethods = {
	(getbufferproc)vec_getbuffer<3, glm::u64>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hu64vec3SeqMethods = {
...
PyNumberMethods hu64vec3NumMethods = {
...
PyGLMTypeObject hu64vec3GLMType = _PyGLM_TYPE_DEF_U64VEC(3);

PyTypeObject& hu64vec3Type = *((PyTypeObject*)&hu64vec3GLMType);
