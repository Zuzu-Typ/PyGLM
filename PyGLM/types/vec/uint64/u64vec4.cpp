...
PyBufferProcs hu64vec4BufferMethods = {
	(getbufferproc)vec_getbuffer<4, glm::u64>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hu64vec4SeqMethods = {
...
PyNumberMethods hu64vec4NumMethods = {
...
PyGLMTypeObject hu64vec4GLMType = _PyGLM_TYPE_DEF_U64VEC(4);

PyTypeObject& hu64vec4Type = *((PyTypeObject*)&hu64vec4GLMType);
