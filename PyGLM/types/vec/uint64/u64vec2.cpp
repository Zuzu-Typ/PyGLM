...
PyBufferProcs hu64vec2BufferMethods = {
	(getbufferproc)vec_getbuffer<2, glm::u64>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hu64vec2SeqMethods = {
...
PyNumberMethods hu64vec2NumMethods = {
...
PyGLMTypeObject hu64vec2GLMType = _PyGLM_TYPE_DEF_U64VEC(2);

PyTypeObject& hu64vec2Type = *((PyTypeObject*)&hu64vec2GLMType);
