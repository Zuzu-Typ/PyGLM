...
PyBufferProcs hi64vec2BufferMethods = {
	(getbufferproc)vec_getbuffer<2, glm::i64>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hi64vec2SeqMethods = {
...
PyNumberMethods hi64vec2NumMethods = {
...
PyGLMTypeObject hi64vec2GLMType = _PyGLM_TYPE_DEF_I64VEC(2);

PyTypeObject& hi64vec2Type = *((PyTypeObject*)&hi64vec2GLMType);
