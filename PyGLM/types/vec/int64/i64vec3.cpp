...
PyMethodDef hi64vec3_methods[] = {
	{ "__copy__", (PyCFunction)generic_copy, METH_NOARGS, "Create a copy of this instance"},
	{ "__deepcopy__", (PyCFunction)generic_deepcopy, METH_O, "Create a (deep)copy of this instance"},
	{ "__getstate__", (PyCFunction)vec3_to_tuple<glm::i64>, METH_NOARGS, "Returns a picklable state of this object"},
	{ "__setstate__", (PyCFunction)vec3_setstate<glm::i64>, METH_O, "Restores a state that was previously acquired"},
	...
	{ "from_bytes", (PyCFunction)vec_from_bytes<3, glm::i64>, METH_O | METH_STATIC, "Create a vector from a bytes string"},
	{ NULL }  /* Sentinel */
};
PyBufferProcs hi64vec3BufferMethods = {
	(getbufferproc)vec_getbuffer<3, glm::i64>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hi64vec3SeqMethods = {
...
PyNumberMethods hi64vec3NumMethods = {
	...
	0, //nb_bool
	(unaryfunc)vec_invert<3, glm::i64>, //nb_invert
	(binaryfunc)vec_lshift<3, glm::i64>, //nb_lshift
	(binaryfunc)vec_rshift<3, glm::i64>, //nb_rshift
	(binaryfunc)vec_and<3, glm::i64>, //nb_and
	(binaryfunc)vec_xor<3, glm::i64>, //nb_xor
	(binaryfunc)vec_or<3, glm::i64>, //nb_or
	0, //nb_int
	0, //nb_reserved
	0, //nb_int
	...
	(binaryfunc)vec_mod<3, glm::i64>, //nb_inplace_remainder
	0, //nb_inplace_power
	(binaryfunc)vec_ilshift<3, glm::i64>, //nb_inplace_lshift
	(binaryfunc)vec_irshift<3, glm::i64>, //nb_inplace_rshift
	(binaryfunc)vec_iand<3, glm::i64>, //nb_inplace_and
	(binaryfunc)vec_ixor<3, glm::i64>, //nb_inplace_xor
	(binaryfunc)vec_ior<3, glm::i64>, //nb_inplace_or
	0, //nb_floor_divide
	...
	(binaryfunc)vec_imatmul<3, glm::i64>, //nb_inplace_matrix_multiply
};
PyTypeObject hi64vec3IterType = {
...
PyGLMTypeObject hi64vec3GLMType = _PyGLM_TYPE_DEF_I64VEC(3);

PyTypeObject& hi64vec3Type = *((PyTypeObject*)&hi64vec3GLMType);
