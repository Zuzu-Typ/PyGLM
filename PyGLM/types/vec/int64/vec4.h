...
static PyGLMTypeObject hi64vec4GLMType = {
	{
		PyVarObject_HEAD_INIT(NULL, 0)
		"glm.i64vec4",             /* tp_name */
		...
		(setattrofunc)vec_setattr<4, glm::i64>,                         /* tp_setattro */
	...
	0,
	sizeof(int64),
	sizeof(glm::vec<4, int64>),
	PyGLM_FS_INT64
};

static PyTypeObject& hi64vec4Type = *((PyTypeObject*)&hi64vec4GLMType);