...
PyMethodDef hi64vec4_methods[] = {
	{ "__copy__", (PyCFunction)generic_copy, METH_NOARGS, "Create a copy of this instance"},
	{ "__deepcopy__", (PyCFunction)generic_deepcopy, METH_O, "Create a (deep)copy of this instance"},
	{ "__getstate__", (PyCFunction)vec4_to_tuple<glm::i64>, METH_NOARGS, "Returns a picklable state of this object"},
	{ "__setstate__", (PyCFunction)vec4_setstate<glm::i64>, METH_O, "Restores a state that was previously acquired"},
	...
	{ "from_bytes", (PyCFunction)vec_from_bytes<4, glm::i64>, METH_O | METH_STATIC, "Create a vector from a bytes string"},
	{ NULL }  /* Sentinel */
};
PyBufferProcs hi64vec4BufferMethods = {
	(getbufferproc)vec_getbuffer<4, glm::i64>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hi64vec4SeqMethods = {
...
PyNumberMethods hi64vec4NumMethods = {
	...
	0, //nb_bool
	(unaryfunc)vec_invert<4, glm::i64>, //nb_invert
	(binaryfunc)vec_lshift<4, glm::i64>, //nb_lshift
	(binaryfunc)vec_rshift<4, glm::i64>, //nb_rshift
	(binaryfunc)vec_and<4, glm::i64>, //nb_and
	(binaryfunc)vec_xor<4, glm::i64>, //nb_xor
	(binaryfunc)vec_or<4, glm::i64>, //nb_or
	0, //nb_int
	0, //nb_reserved
	0, //nb_int
	...
	(binaryfunc)vec_mod<4, glm::i64>, //nb_inplace_remainder
	0, //nb_inplace_power
	(binaryfunc)vec_ilshift<4, glm::i64>, //nb_inplace_lshift
	(binaryfunc)vec_irshift<4, glm::i64>, //nb_inplace_rshift
	...
	(binaryfunc)vec_imatmul<4, glm::i64>, //nb_inplace_matrix_multiply
};
PyTypeObject hi64vec4IterType = {
...
PyGLMTypeObject hi64vec4GLMType = _PyGLM_TYPE_DEF_I64VEC(4);

PyTypeObject& hi64vec4Type = *((PyTypeObject*)&hi64vec4GLMType);
