...
PyBufferProcs hu8vec4BufferMethods = {
	(getbufferproc)vec_getbuffer<4, glm::u8>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hu8vec4SeqMethods = {
...
PyNumberMethods hu8vec4NumMethods = {
...
PyGLMTypeObject hu8vec4GLMType = _PyGLM_TYPE_DEF_U8VEC(4);

PyTypeObject& hu8vec4Type = *((PyTypeObject*)&hu8vec4GLMType);
