...
PyBufferProcs hu8vec3BufferMethods = {
	(getbufferproc)vec_getbuffer<3, glm::u8>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hu8vec3SeqMethods = {
...
PyNumberMethods hu8vec3NumMethods = {
...
PyGLMTypeObject hu8vec3GLMType = _PyGLM_TYPE_DEF_U8VEC(3);

PyTypeObject& hu8vec3Type = *((PyTypeObject*)&hu8vec3GLMType);
