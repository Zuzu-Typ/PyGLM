...
PyBufferProcs hu8vec2BufferMethods = {
	(getbufferproc)vec_getbuffer<2, glm::u8>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hu8vec2SeqMethods = {
...
PyNumberMethods hu8vec2NumMethods = {
...
PyGLMTypeObject hu8vec2GLMType = _PyGLM_TYPE_DEF_U8VEC(2);

PyTypeObject& hu8vec2Type = *((PyTypeObject*)&hu8vec2GLMType);
