...
static PyNumberMethods huvec1NumMethods = {
	...
	(binaryfunc)vec_div<1, glm::u32>, //nb_floor_divide
	(binaryfunc)vec_div<1, glm::u32>,
	(binaryfunc)vec_idiv<1, glm::u32>, //nb_inplace_floor_divide
...
static PyGLMTypeObject huvec1GLMType = {
	{
		PyVarObject_HEAD_INIT(NULL, 0)
		"glm.uvec1",             /* tp_name */
		...
		0,                         /* tp_as_mapping */
		(hashfunc)vec_hash<1, glm::u32>,                         /* tp_hash  */
		0,                         /* tp_call */
	...
	0,
	sizeof(uint32),
	sizeof(glm::vec<1, uint32>),
	PyGLM_FS_UINT32
};

static PyTypeObject& huvec1Type = *((PyTypeObject*)&huvec1GLMType);