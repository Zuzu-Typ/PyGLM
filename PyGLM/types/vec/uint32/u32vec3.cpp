...
PyBufferProcs huvec3BufferMethods = {
	(getbufferproc)vec_getbuffer<3, glm::u32>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods huvec3SeqMethods = {
...
PyNumberMethods huvec3NumMethods = {
...
PyGLMTypeObject huvec3GLMType = _PyGLM_TYPE_DEF_U32VEC(3);

PyTypeObject& huvec3Type = *((PyTypeObject*)&huvec3GLMType);
