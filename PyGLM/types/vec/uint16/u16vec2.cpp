...
PyBufferProcs hu16vec2BufferMethods = {
	(getbufferproc)vec_getbuffer<2, glm::u16>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hu16vec2SeqMethods = {
...
PyNumberMethods hu16vec2NumMethods = {
...
PyGLMTypeObject hu16vec2GLMType = _PyGLM_TYPE_DEF_U16VEC(2);

PyTypeObject& hu16vec2Type = *((PyTypeObject*)&hu16vec2GLMType);
