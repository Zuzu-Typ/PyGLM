...
PyBufferProcs hi16vec1BufferMethods = {
	(getbufferproc)vec_getbuffer<1, glm::i16>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hi16vec1SeqMethods = {
...
PyNumberMethods hi16vec1NumMethods = {
...
PyGLMTypeObject hi16vec1GLMType = _PyGLM_TYPE_DEF_I16VEC(1);

PyTypeObject& hi16vec1Type = *((PyTypeObject*)&hi16vec1GLMType);
