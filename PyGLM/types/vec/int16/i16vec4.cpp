...
PyBufferProcs hi16vec4BufferMethods = {
	(getbufferproc)vec_getbuffer<4, glm::i16>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hi16vec4SeqMethods = {
...
PyNumberMethods hi16vec4NumMethods = {
...
PyGLMTypeObject hi16vec4GLMType = _PyGLM_TYPE_DEF_I16VEC(4);

PyTypeObject& hi16vec4Type = *((PyTypeObject*)&hi16vec4GLMType);
