...
PyMethodDef hi8vec2_methods[] = {
	{ "__copy__", (PyCFunction)generic_copy, METH_NOARGS, "Create a copy of this instance"},
	{ "__deepcopy__", (PyCFunction)generic_deepcopy, METH_O, "Create a (deep)copy of this instance"},
	{ "__getstate__", (PyCFunction)vec2_to_tuple<glm::i8>, METH_NOARGS, "Returns a picklable state of this object"},
	{ "__setstate__", (PyCFunction)vec2_setstate<glm::i8>, METH_O, "Restores a state that was previously acquired"},
	...
	{ "from_bytes", (PyCFunction)vec_from_bytes<2, glm::i8>, METH_O | METH_STATIC, "Create a vector from a bytes string"},
	{ NULL }  /* Sentinel */
};
PyBufferProcs hi8vec2BufferMethods = {
	(getbufferproc)vec_getbuffer<2, glm::i8>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hi8vec2SeqMethods = {
...
PyNumberMethods hi8vec2NumMethods = {
	...
	0, //nb_bool
	(unaryfunc)vec_invert<2, glm::i8>, //nb_invert
	(binaryfunc)vec_lshift<2, glm::i8>, //nb_lshift
	(binaryfunc)vec_rshift<2, glm::i8>, //nb_rshift
	(binaryfunc)vec_and<2, glm::i8>, //nb_and
	(binaryfunc)vec_xor<2, glm::i8>, //nb_xor
	(binaryfunc)vec_or<2, glm::i8>, //nb_or
	0, //nb_int
	0, //nb_reserved
	0, //nb_int
	...
	(binaryfunc)vec_imod<2, glm::i8>, //nb_inplace_remainder
	0, //nb_inplace_power
	(binaryfunc)vec_ilshift<2, glm::i8>, //nb_inplace_lshift
	(binaryfunc)vec_irshift<2, glm::i8>, //nb_inplace_rshift
	(binaryfunc)vec_iand<2, glm::i8>, //nb_inplace_and
	(binaryfunc)vec_ixor<2, glm::i8>, //nb_inplace_xor
	(binaryfunc)vec_ior<2, glm::i8>, //nb_inplace_or
	0, //nb_floor_divide
	...
	(binaryfunc)vec_imatmul<2, glm::i8>, //nb_inplace_matrix_multiply
};
PyTypeObject hi8vec2IterType = {
...
PyGLMTypeObject hi8vec2GLMType = _PyGLM_TYPE_DEF_I8VEC(2);

PyTypeObject& hi8vec2Type = *((PyTypeObject*)&hi8vec2GLMType);
