...
static PyNumberMethods hi8vec2NumMethods = {
	...
	(binaryfunc)ivec_floordiv<2, glm::i8>, //nb_floor_divide
	(binaryfunc)vec_div<2, glm::i8>,
	(binaryfunc)ivec_ifloordiv<2, glm::i8>, //nb_inplace_floor_divide
...
static PyGLMTypeObject hi8vec2GLMType = {
	{
		...
		(setattrofunc)vec_setattr<2, glm::i8>,                         /* tp_setattro */
	...
	0,
	sizeof(int8),
	sizeof(glm::vec<2, int8>),
	PyGLM_FS_INT8
};

static PyTypeObject& hi8vec2Type = *((PyTypeObject*)&hi8vec2GLMType);