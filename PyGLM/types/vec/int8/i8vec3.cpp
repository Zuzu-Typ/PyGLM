...
PyBufferProcs hi8vec3BufferMethods = {
	(getbufferproc)vec_getbuffer<3, glm::i8>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hi8vec3SeqMethods = {
...
PyNumberMethods hi8vec3NumMethods = {
...
PyGLMTypeObject hi8vec3GLMType = _PyGLM_TYPE_DEF_I8VEC(3);

PyTypeObject& hi8vec3Type = *((PyTypeObject*)&hi8vec3GLMType);
