...
PyMemberDef hi8vec4_members[] = {
	{ (char*)"x", T_BYTE, offsetof(vec4_int8_t, super_type.x), 0, (char*)"i8vec4.x" },
	{ (char*)"y", T_BYTE, offsetof(vec4_int8_t, super_type.y), 0, (char*)"i8vec4.y" },
	{ (char*)"z", T_BYTE, offsetof(vec4_int8_t, super_type.z), 0, (char*)"i8vec4.z" },
	{ (char*)"w", T_BYTE, offsetof(vec4_int8_t, super_type.w), 0, (char*)"i8vec4.w" },
	{ NULL }  /* Sentinel */
};
PyMethodDef hi8vec4_methods[] = {
	...
	{ "from_bytes", (PyCFunction)vec_from_bytes<4, glm::i8>, METH_O | METH_STATIC, "Create a vector from a bytes string"},
	{ NULL }  /* Sentinel */
};
PyBufferProcs hi8vec4BufferMethods = {
	(getbufferproc)vec_getbuffer<4, glm::i8>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hi8vec4SeqMethods = {
...
PyGLMTypeObject hi8vec4GLMType = _PyGLM_TYPE_DEF_I8VEC(4);

PyTypeObject& hi8vec4Type = *((PyTypeObject*)&hi8vec4GLMType);
