...
PyBufferProcs hi8vec1BufferMethods = {
	(getbufferproc)vec_getbuffer<1, glm::i8>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hi8vec1SeqMethods = {
...
PyNumberMethods hi8vec1NumMethods = {
...
PyGLMTypeObject hi8vec1GLMType = _PyGLM_TYPE_DEF_I8VEC(1);

PyTypeObject& hi8vec1Type = *((PyTypeObject*)&hi8vec1GLMType);
