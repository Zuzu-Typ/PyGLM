...
PyBufferProcs hivec1BufferMethods = {
	(getbufferproc)vec_getbuffer<1, glm::i32>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hivec1SeqMethods = {
...
PyNumberMethods hivec1NumMethods = {
...
PyGLMTypeObject hivec1GLMType = _PyGLM_TYPE_DEF_I32VEC(1);

PyTypeObject& hivec1Type = *((PyTypeObject*)&hivec1GLMType);
