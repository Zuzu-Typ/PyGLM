...
PyBufferProcs hivec3BufferMethods = {
	(getbufferproc)vec_getbuffer<3, glm::i32>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hivec3SeqMethods = {
...
PyNumberMethods hivec3NumMethods = {
...
PyGLMTypeObject hivec3GLMType = _PyGLM_TYPE_DEF_I32VEC(3);

PyTypeObject& hivec3Type = *((PyTypeObject*)&hivec3GLMType);
