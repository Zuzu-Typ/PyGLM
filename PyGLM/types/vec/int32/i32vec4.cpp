...
PyBufferProcs hivec4BufferMethods = {
	(getbufferproc)vec_getbuffer<4, glm::i32>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hivec4SeqMethods = {
...
PyNumberMethods hivec4NumMethods = {
...
PyGLMTypeObject hivec4GLMType = _PyGLM_TYPE_DEF_I32VEC(4);

PyTypeObject& hivec4Type = *((PyTypeObject*)&hivec4GLMType);
