...
PyBufferProcs hivec2BufferMethods = {
	(getbufferproc)vec_getbuffer<2, glm::i32>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hivec2SeqMethods = {
...
PyNumberMethods hivec2NumMethods = {
...
PyGLMTypeObject hivec2GLMType = _PyGLM_TYPE_DEF_I32VEC(2);

PyTypeObject& hivec2Type = *((PyTypeObject*)&hivec2GLMType);
