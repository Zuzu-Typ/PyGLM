...
PyBufferProcs hdvec1BufferMethods = {
	(getbufferproc)vec_getbuffer<1, double>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hdvec1SeqMethods = {
...
PyNumberMethods hdvec1NumMethods = {
...
PyGLMTypeObject hdvec1GLMType = _PyGLM_TYPE_DEF_DVEC(1);

PyTypeObject& hdvec1Type = *((PyTypeObject*)&hdvec1GLMType);