...
PyBufferProcs hdvec4BufferMethods = {
	(getbufferproc)vec_getbuffer<4, double>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hdvec4SeqMethods = {
...
PyNumberMethods hdvec4NumMethods = {
...
PyGLMTypeObject hdvec4GLMType = _PyGLM_TYPE_DEF_DVEC(4);

PyTypeObject& hdvec4Type = *((PyTypeObject*)&hdvec4GLMType);
