...
PyBufferProcs hfvec4BufferMethods = {
	(getbufferproc)vec_getbuffer<4, float>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hfvec4SeqMethods = {
...
PyNumberMethods hfvec4NumMethods = {
...
PyGLMTypeObject hfvec4GLMType = _PyGLM_TYPE_DEF_FVEC(4);

PyTypeObject& hfvec4Type = *((PyTypeObject*)&hfvec4GLMType);
