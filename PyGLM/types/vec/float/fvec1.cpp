...
PyBufferProcs hfvec1BufferMethods = {
	(getbufferproc)vec_getbuffer<1, float>,
	(releasebufferproc)vec_releasebuffer,
};
PySequenceMethods hfvec1SeqMethods = {
...
PyNumberMethods hfvec1NumMethods = {
...
PyGLMTypeObject hfvec1GLMType = _PyGLM_TYPE_DEF_FVEC(1);

PyTypeObject& hfvec1Type = *((PyTypeObject*)&hfvec1GLMType);
