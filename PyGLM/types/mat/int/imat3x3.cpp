...
PyMappingMethods himat3x3MapMethods = {
...
PyNumberMethods himat3x3NumMethods = {
	...
	(unaryfunc)mat_abs<3, 3, glm::i32>, //nb_absolute
	0, //nb_bool
	0, //nb_invert
	0, //nb_lshift
	0, //nb_rshift
...
PyGLMTypeObject himat3x3GLMType = _PyGLM_TYPE_DEF_IMAT(3, 3);

PyTypeObject& himat3x3Type = *((PyTypeObject*)&himat3x3GLMType);
