...
static PyMethodDef himat3x4_methods[] = {
	...
	{ "__getstate__", (PyCFunction)mat_to_tuple<3, 4, glm::i32>, METH_NOARGS, "Returns a picklable state of this object"},
	{ "__setstate__", (PyCFunction)mat_setstate<3, 4, glm::i32>, METH_O, "Restores a state that was previously acquired"},
