...
PyMethodDef himat4x4_methods[] = {
	{ "__copy__", (PyCFunction)generic_copy, METH_NOARGS, "Create a copy of this instance"},
	{ "__deepcopy__", (PyCFunction)generic_deepcopy, METH_O, "Create a (deep)copy of this instance"},
	{"length", (PyCFunction)mat_length<4>, METH_NOARGS, "returns the length of glm::imat4x4"},
	{ "__getstate__", (PyCFunction)mat_to_tuple<4, 4, glm::i32>, METH_NOARGS, "Returns a picklable state of this object"},
	{ "__setstate__", (PyCFunction)mat_setstate<4, 4, glm::i32>, METH_O, "Restores a state that was previously acquired"},
	...
	{ "from_bytes", (PyCFunction)mat_from_bytes<4, 4, glm::i32>, METH_O | METH_STATIC, "Create a matrix from a bytes string"},
	{ NULL }
};
PyBufferProcs himat4x4BufferMethods = {
	(getbufferproc)mat_getbuffer<4, 4, glm::i32>,
	(releasebufferproc)mat_releasebuffer,
};
PySequenceMethods himat4x4SeqMethods = {
...
PyMappingMethods himat4x4MapMethods = {
...
PyNumberMethods himat4x4NumMethods = {
	(binaryfunc)matsq_add<4, 4, glm::i32>, //nb_add
	...
	(unaryfunc)mat_abs<4, 4, glm::i32>, //nb_absolute
	0, //nb_bool
	0, //nb_invert
	0, //nb_lshift
	0, //nb_rshift
	...
	0, //nb_reserved
	0, //nb_glm::i32
	(binaryfunc)matsq_iadd<4, 4, glm::i32>, //nb_inplace_add
	(binaryfunc)matsq_isub<4, 4, glm::i32>, //nb_inplace_subtract
	...
	(binaryfunc)mat_imatmul<4, 4, glm::i32>, //nb_inplace_matrix_multiply
};
PyTypeObject himat4x4IterType = {
...
PyGLMTypeObject himat4x4GLMType = _PyGLM_TYPE_DEF_IMAT(4, 4);

PyTypeObject& himat4x4Type = *((PyTypeObject*)&himat4x4GLMType);
