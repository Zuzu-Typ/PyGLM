...
static PyMethodDef himat2x2_methods[] = {
	...
	{ "__getstate__", (PyCFunction)mat_to_tuple<2, 2, glm::i32>, METH_NOARGS, "Returns a picklable state of this object"},
	{ "__setstate__", (PyCFunction)mat_setstate<2, 2, glm::i32>, METH_O, "Restores a state that was previously acquired"},
...
static PyNumberMethods himat2x2NumMethods = {
	...
	0, //nb_reserved
	0, //nb_glm::i32
	(binaryfunc)matsq_iadd<2, 2, glm::i32>, //nb_inplace_add
	(binaryfunc)matsq_isub<2, 2, glm::i32>, //nb_inplace_subtract
