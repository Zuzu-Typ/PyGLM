...
PyMethodDef humat4x2_methods[] = {
	{ "__copy__", (PyCFunction)generic_copy, METH_NOARGS, "Create a copy of this instance"},
	{ "__deepcopy__", (PyCFunction)generic_deepcopy, METH_O, "Create a (deep)copy of this instance"},
	{"length", (PyCFunction)mat_length<4>, METH_NOARGS, "returns the length of glm::umat4x2"},
	{ "__getstate__", (PyCFunction)mat_to_tuple<4, 2, glm::u32>, METH_NOARGS, "Returns a picklable state of this object"},
	{ "__setstate__", (PyCFunction)mat_setstate<4, 2, glm::u32>, METH_O, "Restores a state that was previously acquired"},
	...
	{ "from_bytes", (PyCFunction)mat_from_bytes<4, 2, glm::u32>, METH_O | METH_STATIC, "Create a matrix from a bytes string"},
	{ NULL }
};
PyBufferProcs humat4x2BufferMethods = {
	(getbufferproc)mat_getbuffer<4, 2, glm::u32>,
	(releasebufferproc)mat_releasebuffer,
};
PySequenceMethods humat4x2SeqMethods = {
...
PyMappingMethods humat4x2MapMethods = {
...
PyNumberMethods humat4x2NumMethods = {
	...
	(unaryfunc)mat_abs<4, 2, glm::u32>, //nb_absolute
	0, //nb_bool
	0, //nb_invert
	0, //nb_lshift
	0, //nb_rshift
	...
	(binaryfunc)mat_imatmul<4, 2, glm::u32>, //nb_inplace_matrix_multiply
};
PyTypeObject humat4x2IterType = {
...
PyGLMTypeObject humat4x2GLMType = _PyGLM_TYPE_DEF_UMAT(4, 2);

PyTypeObject& humat4x2Type = *((PyTypeObject*)&humat4x2GLMType);
