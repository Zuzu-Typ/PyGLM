...
PyMappingMethods humat2x2MapMethods = {
...
PyNumberMethods humat2x2NumMethods = {
	...
	(unaryfunc)mat_abs<2, 2, glm::u32>, //nb_absolute
	0, //nb_bool
	0, //nb_invert
	0, //nb_lshift
	0, //nb_rshift
...
PyGLMTypeObject humat2x2GLMType = _PyGLM_TYPE_DEF_UMAT(2, 2);

PyTypeObject& humat2x2Type = *((PyTypeObject*)&humat2x2GLMType);
