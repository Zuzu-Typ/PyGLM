...
PyMethodDef humat3x2_methods[] = {
	...
	{ "from_bytes", (PyCFunction)mat_from_bytes<3, 2, glm::u32>, METH_O | METH_STATIC, "Create a matrix from a bytes string"},
	{ NULL }
};
PyBufferProcs humat3x2BufferMethods = {
	(getbufferproc)mat_getbuffer<3, 2, glm::u32>,
	(releasebufferproc)mat_releasebuffer,
};
PySequenceMethods humat3x2SeqMethods = {
...
PyMappingMethods humat3x2MapMethods = {
...
PyNumberMethods humat3x2NumMethods = {
	...
	(unaryfunc)mat_abs<3, 2, glm::u32>, //nb_absolute
	0, //nb_bool
	0, //nb_invert
	0, //nb_lshift
	0, //nb_rshift
	...
	(binaryfunc)mat_imatmul<3, 2, glm::u32>, //nb_inplace_matrix_multiply
};
PyTypeObject humat3x2IterType = {
...
PyGLMTypeObject humat3x2GLMType = _PyGLM_TYPE_DEF_UMAT(3, 2);

PyTypeObject& humat3x2Type = *((PyTypeObject*)&humat3x2GLMType);