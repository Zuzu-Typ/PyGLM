...
PyMappingMethods humat4x4MapMethods = {
...
PyNumberMethods humat4x4NumMethods = {
	...
	(unaryfunc)mat_abs<4, 4, glm::u32>, //nb_absolute
	0, //nb_bool
	0, //nb_invert
	0, //nb_lshift
	0, //nb_rshift
...
PyGLMTypeObject humat4x4GLMType = _PyGLM_TYPE_DEF_UMAT(4, 4);

PyTypeObject& humat4x4Type = *((PyTypeObject*)&humat4x4GLMType);
