...
PyMethodDef humat3x4_methods[] = {
	{ "__copy__", (PyCFunction)generic_copy, METH_NOARGS, "Create a copy of this instance"},
	{ "__deepcopy__", (PyCFunction)generic_deepcopy, METH_O, "Create a (deep)copy of this instance"},
	{"length", (PyCFunction)mat_length<3>, METH_NOARGS, "returns the length of glm::umat3x4"},
	{ "__getstate__", (PyCFunction)mat_to_tuple<3, 4, glm::u32>, METH_NOARGS, "Returns a picklable state of this object"},
...
PyMappingMethods humat3x4MapMethods = {
...
PyNumberMethods humat3x4NumMethods = {
	...
	(unaryfunc)mat_abs<3, 4, glm::u32>, //nb_absolute
	0, //nb_bool
	0, //nb_invert
	0, //nb_lshift
	0, //nb_rshift
	...
	(binaryfunc)mat_imatmul<3, 4, glm::u32>, //nb_inplace_matrix_multiply
};
PyTypeObject humat3x4IterType = {
...
PyGLMTypeObject humat3x4GLMType = _PyGLM_TYPE_DEF_UMAT(3, 4);

PyTypeObject& humat3x4Type = *((PyTypeObject*)&humat3x4GLMType);