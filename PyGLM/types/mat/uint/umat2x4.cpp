...
PyMappingMethods humat2x4MapMethods = {
...
PyNumberMethods humat2x4NumMethods = {
	...
	(unaryfunc)mat_abs<2, 4, glm::u32>, //nb_absolute
	0, //nb_bool
	0, //nb_invert
	0, //nb_lshift
	0, //nb_rshift
...
PyGLMTypeObject humat2x4GLMType = _PyGLM_TYPE_DEF_UMAT(2, 4);

PyTypeObject& humat2x4Type = *((PyTypeObject*)&humat2x4GLMType);
