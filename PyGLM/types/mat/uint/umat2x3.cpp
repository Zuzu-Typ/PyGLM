...
PyMethodDef humat2x3_methods[] = {
	{ "__copy__", (PyCFunction)generic_copy, METH_NOARGS, "Create a copy of this instance"},
	{ "__deepcopy__", (PyCFunction)generic_deepcopy, METH_O, "Create a (deep)copy of this instance"},
	{"length", (PyCFunction)mat_length<2>, METH_NOARGS, "returns the length of glm::umat2x3"},
	{ "__getstate__", (PyCFunction)mat_to_tuple<2, 3, glm::u32>, METH_NOARGS, "Returns a picklable state of this object"},
	{ "__setstate__", (PyCFunction)mat_setstate<2, 3, glm::u32>, METH_O, "Restores a state that was previously acquired"},
	...
	{ "from_bytes", (PyCFunction)mat_from_bytes<2, 3, glm::u32>, METH_O | METH_STATIC, "Create a matrix from a bytes string"},
	{ NULL }
};
PyBufferProcs humat2x3BufferMethods = {
	(getbufferproc)mat_getbuffer<2, 3, glm::u32>,
	(releasebufferproc)mat_releasebuffer,
};
PySequenceMethods humat2x3SeqMethods = {
...
PyMappingMethods humat2x3MapMethods = {
...
PyNumberMethods humat2x3NumMethods = {
	...
	(unaryfunc)mat_abs<2, 3, glm::u32>, //nb_absolute
	0, //nb_bool
	0, //nb_invert
	0, //nb_lshift
	0, //nb_rshift
...
PyGLMTypeObject humat2x3GLMType = _PyGLM_TYPE_DEF_UMAT(2, 3);

PyTypeObject& humat2x3Type = *((PyTypeObject*)&humat2x3GLMType);
