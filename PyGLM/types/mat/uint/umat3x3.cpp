...
PyMappingMethods humat3x3MapMethods = {
...
PyNumberMethods humat3x3NumMethods = {
	...
	(unaryfunc)mat_abs<3, 3, glm::u32>, //nb_absolute
	0, //nb_bool
	0, //nb_invert
	0, //nb_lshift
	0, //nb_rshift
...
PyGLMTypeObject humat3x3GLMType = _PyGLM_TYPE_DEF_UMAT(3, 3);

PyTypeObject& humat3x3Type = *((PyTypeObject*)&humat3x3GLMType);
