...
PyMethodDef hfmat3x4_methods[] = {
	{ "__copy__", (PyCFunction)generic_copy, METH_NOARGS, "Create a copy of this instance"},
	{ "__deepcopy__", (PyCFunction)generic_deepcopy, METH_O, "Create a (deep)copy of this instance"},
	{"length", (PyCFunction)mat_length<3>, METH_NOARGS, "returns the length of glm::mat3x4"},
	{ "__getstate__", (PyCFunction)mat_to_tuple<3, 4, float>, METH_NOARGS, "Returns a picklable state of this object"},
	{ "__setstate__", (PyCFunction)mat_setstate<3, 4, float>, METH_O, "Restores a state that was previously acquired"},
	...
	{ "from_bytes", (PyCFunction)mat_from_bytes<3, 4, float>, METH_O | METH_STATIC, "Create a matrix from a bytes string"},
	{ NULL }
};
PyBufferProcs hfmat3x4BufferMethods = {
	(getbufferproc)mat_getbuffer<3, 4, float>,
	(releasebufferproc)mat_releasebuffer,
};
PySequenceMethods hfmat3x4SeqMethods = {
...
PyMappingMethods hfmat3x4MapMethods = {
...
PyNumberMethods hfmat3x4NumMethods = {
	...
	(binaryfunc)mat_imatmul<3, 4, float>, //nb_inplace_matrix_multiply
};
PyTypeObject hfmat3x4IterType = {
...
PyGLMTypeObject hfmat3x4GLMType = _PyGLM_TYPE_DEF_FMAT(3, 4);

PyTypeObject& hfmat3x4Type = *((PyTypeObject*)&hfmat3x4GLMType);