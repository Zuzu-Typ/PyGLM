...
PyMethodDef hfmat2x3_methods[] = {
	{ "__copy__", (PyCFunction)generic_copy, METH_NOARGS, "Create a copy of this instance"},
	{ "__deepcopy__", (PyCFunction)generic_deepcopy, METH_O, "Create a (deep)copy of this instance"},
	{"length", (PyCFunction)mat_length<2>, METH_NOARGS, "returns the length of glm::mat2x3"},
	{ "__getstate__", (PyCFunction)mat_to_tuple<2, 3, float>, METH_NOARGS, "Returns a picklable state of this object"},
	{ "__setstate__", (PyCFunction)mat_setstate<2, 3, float>, METH_O, "Restores a state that was previously acquired"},
	...
	{ "from_bytes", (PyCFunction)mat_from_bytes<2, 3, float>, METH_O | METH_STATIC, "Create a matrix from a bytes string"},
	{ NULL }
};
PyBufferProcs hfmat2x3BufferMethods = {
	(getbufferproc)mat_getbuffer<2, 3, float>,
	(releasebufferproc)mat_releasebuffer,
};
PySequenceMethods hfmat2x3SeqMethods = {
...
PyMappingMethods hfmat2x3MapMethods = {
...
PyNumberMethods hfmat2x3NumMethods = {
	...
	(binaryfunc)mat_imatmul<2, 3, float>, //nb_inplace_matrix_multiply
};
PyTypeObject hfmat2x3IterType = {
...
PyGLMTypeObject hfmat2x3GLMType = _PyGLM_TYPE_DEF_FMAT(2, 3);

PyTypeObject& hfmat2x3Type = *((PyTypeObject*)&hfmat2x3GLMType);