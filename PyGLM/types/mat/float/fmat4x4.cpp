...
PyMethodDef hfmat4x4_methods[] = {
	{ "__copy__", (PyCFunction)generic_copy, METH_NOARGS, "Create a copy of this instance"},
	{ "__deepcopy__", (PyCFunction)generic_deepcopy, METH_O, "Create a (deep)copy of this instance"},
	{"length", (PyCFunction)mat_length<4>, METH_NOARGS, "returns the length of glm::mat4x4"},
	{ "__getstate__", (PyCFunction)mat_to_tuple<4, 4, float>, METH_NOARGS, "Returns a picklable state of this object"},
	{ "__setstate__", (PyCFunction)mat_setstate<4, 4, float>, METH_O, "Restores a state that was previously acquired"},
	...
	{ "from_bytes", (PyCFunction)mat_from_bytes<4, 4, float>, METH_O | METH_STATIC, "Create a matrix from a bytes string"},
	{ NULL }
};
PyBufferProcs hfmat4x4BufferMethods = {
	(getbufferproc)mat_getbuffer<4, 4, float>,
	(releasebufferproc)mat_releasebuffer,
};
PySequenceMethods hfmat4x4SeqMethods = {
...
PyMappingMethods hfmat4x4MapMethods = {
...
PyNumberMethods hfmat4x4NumMethods = {
...
PyGLMTypeObject hfmat4x4GLMType = _PyGLM_TYPE_DEF_FMAT(4, 4);

PyTypeObject& hfmat4x4Type = *((PyTypeObject*)&hfmat4x4GLMType);
