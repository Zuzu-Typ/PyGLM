...
PyMethodDef hfmat4x3_methods[] = {
	{ "__copy__", (PyCFunction)generic_copy, METH_NOARGS, "Create a copy of this instance"},
	{ "__deepcopy__", (PyCFunction)generic_deepcopy, METH_O, "Create a (deep)copy of this instance"},
	{"length", (PyCFunction)mat_length<4>, METH_NOARGS, "returns the length of glm::mat4x3"},
	{ "__getstate__", (PyCFunction)mat_to_tuple<4, 3, float>, METH_NOARGS, "Returns a picklable state of this object"},
	{ "__setstate__", (PyCFunction)mat_setstate<4, 3, float>, METH_O, "Restores a state that was previously acquired"},
	...
	{ "from_bytes", (PyCFunction)mat_from_bytes<4, 3, float>, METH_O | METH_STATIC, "Create a matrix from a bytes string"},
	{ NULL }
};
PyBufferProcs hfmat4x3BufferMethods = {
	(getbufferproc)mat_getbuffer<4, 3, float>,
	(releasebufferproc)mat_releasebuffer,
};
PySequenceMethods hfmat4x3SeqMethods = {
...
PyMappingMethods hfmat4x3MapMethods = {
...
PyNumberMethods hfmat4x3NumMethods = {
...
PyGLMTypeObject hfmat4x3GLMType = _PyGLM_TYPE_DEF_FMAT(4, 3);

PyTypeObject& hfmat4x3Type = *((PyTypeObject*)&hfmat4x3GLMType);
