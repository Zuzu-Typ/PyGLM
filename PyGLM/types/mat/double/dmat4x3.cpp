...
PyMappingMethods hdmat4x3MapMethods = {
...
PyNumberMethods hdmat4x3NumMethods = {
...
PyGLMTypeObject hdmat4x3GLMType = _PyGLM_TYPE_DEF_DMAT(4, 3);

PyTypeObject& hdmat4x3Type = *((PyTypeObject*)&hdmat4x3GLMType);
