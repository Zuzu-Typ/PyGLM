...
PyMappingMethods hdmat3x4MapMethods = {
...
PyNumberMethods hdmat3x4NumMethods = {
...
PyGLMTypeObject hdmat3x4GLMType = _PyGLM_TYPE_DEF_DMAT(3, 4);

PyTypeObject& hdmat3x4Type = *((PyTypeObject*)&hdmat3x4GLMType);
