...
PyMethodDef hdmat3x3_methods[] = {
	...
	{ "from_bytes", (PyCFunction)mat_from_bytes<3, 3, double>, METH_O | METH_STATIC, "Create a matrix from a bytes string"},
	{ NULL }
};
PyBufferProcs hdmat3x3BufferMethods = {
	(getbufferproc)mat_getbuffer<3, 3, double>,
	(releasebufferproc)mat_releasebuffer,
};
PySequenceMethods hdmat3x3SeqMethods = {
...
PyMappingMethods hdmat3x3MapMethods = {
...
PyNumberMethods hdmat3x3NumMethods = {
...
PyGLMTypeObject hdmat3x3GLMType = _PyGLM_TYPE_DEF_DMAT(3, 3);

PyTypeObject& hdmat3x3Type = *((PyTypeObject*)&hdmat3x3GLMType);