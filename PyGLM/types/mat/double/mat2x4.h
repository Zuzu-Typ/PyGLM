...
PyMappingMethods hdmat2x4MapMethods = {
...
PyNumberMethods hdmat2x4NumMethods = {
...
PyGLMTypeObject hdmat2x4GLMType = _PyGLM_TYPE_DEF_DMAT(2, 4);

PyTypeObject& hdmat2x4Type = *((PyTypeObject*)&hdmat2x4GLMType);
