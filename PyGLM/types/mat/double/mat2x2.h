...
PyMappingMethods hdmat2x2MapMethods = {
...
PyNumberMethods hdmat2x2NumMethods = {
...
PyGLMTypeObject hdmat2x2GLMType = _PyGLM_TYPE_DEF_DMAT(2, 2);

PyTypeObject& hdmat2x2Type = *((PyTypeObject*)&hdmat2x2GLMType);
