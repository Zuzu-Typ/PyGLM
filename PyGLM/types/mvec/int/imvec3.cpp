...
PyMethodDef himvec3_methods[] = {
	...
	{ "__getstate__", (PyCFunction)mvec3_to_tuple<glm::i32>, METH_NOARGS, "Returns a picklable state of this object"},
	{ "__setstate__", (PyCFunction)mvec3_setstate<glm::i32>, METH_O, "Restores a state that was previously acquired"},
	{ "to_list", (PyCFunction)mvec3_to_list<glm::i32>, METH_NOARGS, "Return the components of this vector as a list"},
	{ "to_tuple", (PyCFunction)mvec3_to_tuple<glm::i32>, METH_NOARGS, "Return the components of this vector as a tuple"},
	{ "to_bytes", (PyCFunction)generic_to_bytes, METH_NOARGS, "Create a bytes string from this object"},
	{ NULL }  /* Sentinel */
};
PyBufferProcs himvec3BufferMethods = {
	(getbufferproc)mvec_getbuffer<3, glm::i32>,
	(releasebufferproc)mvec_releasebuffer,
};
PySequenceMethods himvec3SeqMethods = {
...
PyNumberMethods himvec3NumMethods = {
	...
	0, //nb_bool
	(unaryfunc)mvec_invert<3, glm::i32>, //nb_invert
	(binaryfunc)mvec_lshift<3, glm::i32>, //nb_lshift
	(binaryfunc)mvec_rshift<3, glm::i32>, //nb_rshift
	(binaryfunc)mvec_and<3, glm::i32>, //nb_and
	(binaryfunc)mvec_xor<3, glm::i32>, //nb_xor
	(binaryfunc)mvec_or<3, glm::i32>, //nb_or
	0, //nb_int
	0, //nb_reserved
	0, //nb_int
	...
	0, //nb_inplace_power
	(binaryfunc)mvec_ilshift<3, glm::i32>, //nb_inplace_lshift
	(binaryfunc)mvec_irshift<3, glm::i32>, //nb_inplace_rshift
	...
	(binaryfunc)mvec_imatmul<3, glm::i32>, //nb_inplace_matrix_multiply
};
PyTypeObject himvec3IterType = {
...
PyGLMTypeObject himvec3GLMType = _PyGLM_TYPE_DEF_IMVEC(3);

PyTypeObject& himvec3Type = *((PyTypeObject*)&himvec3GLMType);
