...
PyNumberMethods hfmvec4NumMethods = {
...
PyGLMTypeObject hfmvec4GLMType = _PyGLM_TYPE_DEF_FMVEC(4);

PyTypeObject& hfmvec4Type = *((PyTypeObject*)&hfmvec4GLMType);
