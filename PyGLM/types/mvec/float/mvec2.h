...
PyNumberMethods hfmvec2NumMethods = {
...
PyGLMTypeObject hfmvec2GLMType = _PyGLM_TYPE_DEF_FMVEC(2);

PyTypeObject& hfmvec2Type = *((PyTypeObject*)&hfmvec2GLMType);