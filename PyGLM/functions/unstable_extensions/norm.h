	...
	if (arg3 == NULL) {
		if (PyLong_Check(arg2)) {
			if (PyGLM_Vec_Check(3, float, arg1)) {
				return pack(glm::lxNorm(unpack_vec<3, float>(arg1), PyGLM_Number_AsUnsignedLong(arg2)));
			}
			if (PyGLM_Vec_Check(3, double, arg1)) {
				return pack(glm::lxNorm(unpack_vec<3, double>(arg1), PyGLM_Number_AsUnsignedLong(arg2)));
			}
		}
	}
	else {
		if (PyLong_Check(arg3)) {
			if (PyGLM_Vec_Check(3, float, arg1) && PyGLM_Vec_Check(3, float, arg2)) {
				return pack(glm::lxNorm(unpack_vec<3, float>(arg1), unpack_vec<3, float>(arg2), PyGLM_Number_AsUnsignedLong(arg3)));
			}
			if (PyGLM_Vec_Check(3, double, arg1) && PyGLM_Vec_Check(3, double, arg2)) {
				return pack(glm::lxNorm(unpack_vec<3, double>(arg1), unpack_vec<3, double>(arg2), PyGLM_Number_AsUnsignedLong(arg3)));
			}
		}
	}
