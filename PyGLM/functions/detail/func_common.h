...
PyDoc_STRVAR(fmin_docstr,
	...
	"	For every index i:\n"
	"	Returns y[i] if y[i] < x[i]; otherwise, it returns x[i]. If one of the two arguments is NaN, the value\n"
	"	of the other argument is returned.\n"
...
PyDoc_STRVAR(fmax_docstr,
	...
	"	For every index i:\n"
	"	Returns y[i] if x[i] < y[i]; otherwise, it returns x[i]. If one of the two arguments is NaN, the value\n"
	"	of the other argument is returned.\n"
