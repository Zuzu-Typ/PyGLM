...
PyDoc_STRVAR(packUnorm2x16_docstr,
	...
	"	The conversion for component c of v to fixed point is done as follows : packUnorm2x16:\n"
...
PyDoc_STRVAR(packSnorm2x16_docstr,
	...
	"	First, converts each component of the normalized floating-point value v into 8- or 16-bit\n"
	"	integer values. Then, the results are packed into the returned 32 - bit unsigned integer.\n"
	"	The conversion for component c of v to fixed point is done as follows : packSnorm2x16: \n"
...
PyDoc_STRVAR(packUnorm4x8_docstr,
	...
	"	First, converts each component of the normalized floating-point value v into 8- or 16-bit\n"
	"	integer values. Then, the results are packed into the returned 32 - bit unsigned integer.\n"
	"	The conversion for component c of v to fixed point is done as follows : packUnorm4x8:\n"
...
PyDoc_STRVAR(packSnorm4x8_docstr,
	...
	"	First, converts each component of the normalized floating-point value v into 8- or 16-bit\n"
	"	integer values. Then, the results are packed into the returned 32 - bit unsigned integer.\n"
	"	The conversion for component c of v to fixed point is done as follows : packSnorm4x8:\n"
...
PyDoc_STRVAR(unpackUnorm2x16_docstr,
	...
	"	is done as follows : unpackUnorm2x16: f / 65535.0. The first component of the returned\n"
...
PyDoc_STRVAR(unpackSnorm2x16_docstr,
	...
	"	converted to a normalized floating - point value to generate the returned two- or\n"
	"	four-component vector. The conversion for unpacked fixed - point value f to floating point\n"
	"	is done as follows : unpackSnorm2x16: clamp(f / 32767.0, -1, +1). The first component of\n"
...
PyDoc_STRVAR(unpackUnorm4x8_docstr,
	...
	"	converted to a normalized floating - point value to generate the returned two- or\n"
	"	four-component vector. The conversion for unpacked fixed - point value f to floating point\n"
	"	is done as follows : unpackUnorm4x8: f / 255.0. The first component of the returned vector\n"
...
PyDoc_STRVAR(unpackSnorm4x8_docstr,
	...
	"	converted to a normalized floating - point value to generate the returned two- or\n"
	"	four-component vector. The conversion for unpacked fixed - point value f to floating point\n"
	"	is done as follows : unpackSnorm4x8: clamp(f / 127.0, -1, +1). The first component of the\n"
