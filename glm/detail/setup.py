...
GLM_C_FLOAT_SIZE = ctypes.sizeof(ctypes.c_float)

GLM_NON_GLM_TYPE = None

def pyglmCompareType(of_, with_):
	try:
		return of_.__class__ == with_
	except:
		return GLM_NON_GLM_TYPE

def pyglmTypeIn(type_, in_):
	try:
		return type_.__class__ in in_
	except:
		return GLM_NON_GLM_TYPE
